...
public static void main(String[] args) {
	...
	if (contractType == 'E') {
		...
		double netIncome = income - ((soc_securitys + soc_health_security + soc_sick_security) + soc_health1 + advanceTaxPaid0);
		...
		System.out.println("Advance tax  = " + df00.format(advanceTaxPaid) + " roundedu = " + df.format(advanceTaxPaid0));
